...
//        Task<TResponse> PerformOperationAsync<TResponse>(string requestString);
...
//        /// <returns>The response object with the result of the request</returns>
//        Task<TResponse> PerformOperationWithFileAsync<TResponse>(string requestString, Stream fileStream);
//    }
//}