...
using SynoDs.Universal.Infrastructure;
using SynoDs.Universal;
...
namespace SynoDs.Universal
{
    ...
    {
        private IModuleManager moduleInitializer;
        private AppModulesCatalog modulesCatalog;
        private BootstrapperBase bootstrapper;

#if WINDOWS_PHONE_APP
        private TransitionCollection transitions;
#endif
#if WINDOWS_RT_APP
        moduleInitializer = new WinRtAppModuleCatalogInitializer();
        bootstrapper = null;
#endif
